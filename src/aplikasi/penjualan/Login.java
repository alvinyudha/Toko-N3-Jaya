...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 560, 230));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtuser.getText().equals("") || txtpass.getText().equals("")) {
            ...
            try {
                ListLogin = uc.cariLogin(txtuser.getText(), enkripsi.getSHA1(txtpass.getText()));
                if (ListLogin.size()>1){
                if (ListLogin.get(0).gethak_akses().equalsIgnoreCase("administrator")) {
                    Menu_Utama mu = new Menu_Utama();
                    mu.setVisible(true);
                    mu.tapiluser(txtuser.getText());
                    dispose();
                } else {
                    Menu_Utama mu = new Menu_Utama();
                    mu.setVisible(true);
